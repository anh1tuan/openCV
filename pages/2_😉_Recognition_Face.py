...
FRAME_WINDOW = st.image('utility\\images\\video_notfound.jpg')
...
if 'frame_stop' not in st.session_state:
    frame_stop = cv.imread('utility\\images\\video_notfound.jpg')
...
svc = joblib.load('utility\\RecognitionFace\\svc.pkl')
mydict = ['Tuan Anh', 'Binh An', 'Tien Duc', 'Thanh Trung','Thanh Dat']
...
if __name__ == '__main__':
    detector = cv.FaceDetectorYN.create(
        'utility\\DetectionFace\\face_detection_yunet_2022mar.onnx',
        "",
        (320, 320),
        0.9,
        0.3,
    ...
    'utility\\DetectionFace\\face_recognition_sface_2021dec.onnx',"")
